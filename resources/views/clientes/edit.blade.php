                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="position-relative form-group"><label for="nome" class="">Nome/Razão
                                    ...
                                    type="text" class="form-control" value="{{ $client['nome']}}"></div>
                        </div>
                        <div class="col-md-6">
                            <div class="position-relative form-group"><label for="cnpj" class="">CNPJ</label><input
                                    ...
                                    value="{{ $client['cnpj']}}" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="position-relative form-group"><label for="senha" class="">Senha</label><input
                                    ...
                                    class="form-control" value="{{ $client['senha']}}"></div>
                        </div>
                        <div class="col-md-6">
